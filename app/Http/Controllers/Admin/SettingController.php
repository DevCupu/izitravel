...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $keys = [
            ...
            'registration_step_7_title', 'registration_step_7_description',
            'package_note_1',
            'package_note_2',
            'package_note_3',
            'hero_calligraphy',
        ...
        $request->validate([
            ...
            'registration_step_7_title'       => ['nullable', 'string', 'max:100'],
            'registration_step_7_description' => ['nullable', 'string', 'max:255'],
            ...
            'registration_step_7_icon' => ['nullable', 'string', 'max:50'],
