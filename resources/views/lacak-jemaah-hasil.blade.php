...
<head>
    ...
    <title>Hasil Status Keberangkatan - {{ $siteName }}</title>
    ...
    <header class="fixed top-4 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-7xl z-50">
        <nav class="bg-white border border-slate-100/80 rounded-full shadow-[0_10px_35px_-10px_rgba(0,0,0,0.05)] px-6 py-3 flex items-center justify-between transition-all duration-300">
            ...
            <div class="flex items-center gap-2">
                <a class="hidden sm:inline-flex items-center gap-1.5 bg-blue-600 text-white px-3.5 py-2.5 rounded-full font-bold hover:bg-blue-700 transition-all duration-300 text-xs shadow-md shadow-blue-500/10 active:scale-95" href="{{ route('public.jemaah.tracking') }}">
                    <i data-lucide="search-check" class="w-4 h-4"></i>
                    <span>Cek Keberangkatan</span>
                </a>
