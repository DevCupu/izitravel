    ...
    <header class="fixed top-4 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-7xl z-50">
        <nav class="bg-white border border-slate-100/80 rounded-full shadow-[0_10px_35px_-10px_rgba(0,0,0,0.05)] px-6 py-3 flex items-center justify-between transition-all duration-300">
            ...
            <div class="hidden md:flex items-center">
                ...
                <a class="relative text-blue-600 text-[14px] font-extrabold tracking-tight px-2.5 py-2 transition duration-200 after:absolute after:bottom-0.5 after:left-2.5 after:right-2.5 after:h-[2px] after:bg-blue-600 after:rounded-full" href="{{ url('/#paket-umrah') }}">Paket Umrah</a>
