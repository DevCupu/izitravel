                            ...
                            <tr class="hover:bg-slate-50/60 dark:hover:bg-slate-700/30 transition group">
                                ...
                                <td class="px-5 py-3.5 text-right">
                                    <div class="flex items-center justify-end gap-1 opacity-60 group-hover:opacity-100 transition">
                                        <a href="{{ route('admin.testimonials.edit', $testimonial) }}" class="p-2 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 transition" title="{{ __('Ubah') }}">
                                            <i data-lucide="pencil" class="w-4 h-4"></i>
                                        </a>
                                        <form method="POST" action="{{ route('admin.testimonials.destroy', $testimonial) }}" class="delete-form">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
