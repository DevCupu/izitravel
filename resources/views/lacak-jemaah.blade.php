...
<head>
    ...
    <title>Status Keberangkatan - {{ $siteName }}</title>
...
<body class="bg-stone-50 text-stone-800 overflow-x-hidden antialiased">
    ...
    <header class="fixed top-4 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-7xl z-50">
        <nav class="bg-white/90 backdrop-blur-md border border-white/60 rounded-full shadow-[0_10px_35px_-10px_rgba(0,0,0,0.05)] px-6 py-3 flex items-center justify-between transition-all duration-300">
            ...
            <div class="hidden md:flex items-center">
                <a class="relative text-red-600 hover:text-red-700 text-[14px] font-bold tracking-tight px-2.5 py-2 transition duration-200 after:absolute after:bottom-0.5 after:left-2.5 after:right-2.5 after:h-[2px] after:bg-red-600 after:rounded-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300" href="{{ url('/') }}#beranda">Beranda</a>
                ...
                <a class="relative text-stone-600 hover:text-blue-600 text-[14px] font-bold tracking-tight px-2.5 py-2 transition duration-200 after:absolute after:bottom-0.5 after:left-2.5 after:right-2.5 after:h-[2px] after:bg-blue-600 after:rounded-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300" href="{{ route('public.articles.index') }}">Artikel</a>
    ...
    <section class="relative pt-32 pb-16 bg-blue-950 overflow-hidden islamic-pattern">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-4">
            ...
            <p class="text-stone-300 max-w-lg mx-auto text-xs md:text-sm">Cukup masukkan nomor paspor dan tanggal lahir Anda, lalu lihat detail paket, jadwal keberangkatan, hingga sejauh mana persiapan dokumen Anda sudah selesai.</p>
        </div>
    </section>
    <!-- END: Banner Header -->
    ...
    <section class="py-16 bg-stone-50">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <!-- Search Card -->
            <div class="bg-white rounded-[2rem] border border-stone-100/80 p-6 sm:p-8 soft-shadow relative overflow-hidden">
                ...
                <form method="GET" action="{{ route('public.jemaah.tracking.result') }}" class="space-y-3">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div class="relative">
                            <i data-lucide="scan-search" class="w-4 h-4 text-stone-400 absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none"></i>
                            <input
                                type="text"
                                name="passport"
                                placeholder="Nomor Paspor, contoh: A1234567"
                                class="w-full pl-11 pr-4 py-3.5 text-sm border border-stone-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-2xl"
                                autofocus
                                required
                            >
                        </div>
                        <div class="relative">
                            <i data-lucide="calendar" class="w-4 h-4 text-stone-400 absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none"></i>
                            <input
                                type="date"
                                name="birth_date"
                                class="w-full pl-11 pr-4 py-3.5 text-sm border border-stone-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-2xl"
            ...
            <div class="text-center py-10 space-y-3">
                ...
                <p class="text-sm text-stone-400 max-w-xs mx-auto">Untuk menjaga privasi Anda, pencarian membutuhkan nomor paspor dan tanggal lahir sekaligus — sesuai data yang terdaftar di sistem kami.</p>
            </div>
        </div>
    </section>
    <!-- END: Content Section -->
    ...
    <!-- BEGIN: Footer -->
    <footer class="bg-stone-950 text-white py-16 md:py-24 relative overflow-hidden islamic-pattern-blue-soft" id="kontak">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 mb-16">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex flex-wrap gap-2.5">
                            ...
                            <a class="w-9 h-9 bg-white/5 hover:bg-amber-500/10 hover:border-amber-500/50 text-white hover:text-amber-400 border border-white/10 rounded-xl flex items-center justify-center transition-all duration-300 active:scale-95 shadow-sm" href="{{ $settings['social_youtube'] }}" target="_blank" aria-label="YouTube">
                                <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.872.505 9.377.505 9.377.505s7.505 0 9.377-.505a3.017 3.017 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"></path></svg>
                            </a>
                            @endif
                            ...
                            <a class="w-9 h-9 bg-white/5 hover:bg-amber-500/10 hover:border-amber-500/50 text-white hover:text-amber-400 border border-white/10 rounded-xl flex items-center justify-center transition-all duration-300 active:scale-95 shadow-sm" href="{{ $settings['social_tiktok'] }}" target="_blank" aria-label="TikTok">
                                <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path></svg>
                            </a>
                            @endif
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <ul class="space-y-3.5 text-xs text-stone-400">
                        <li><a href="{{ url('/') }}#beranda" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Beranda</a></li>
                        <li><a href="{{ url('/') }}#tentang-kami" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Tentang Kami</a></li>
                        <li><a href="{{ url('/') }}#paket-umrah" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Paket Umrah</a></li>
                        <li><a href="{{ route('public.jemaah.tracking') }}" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Status Keberangkatan</a></li>
                        <li><a href="{{ route('public.gallery') }}" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Galeri Kegiatan</a></li>
                        <li><a href="{{ route('public.testimonials') }}" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Testimoni Jemaah</a></li>
                        <li><a href="{{ route('public.articles.index') }}" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Berita &amp; Artikel</a></li>
                        <li><a href="{{ url('/') }}#kemitraan" class="hover:text-amber-400 transition duration-200 flex items-center gap-2 group/link"><i data-lucide="chevron-right" class="w-3.5 h-3.5 text-amber-500/60 group-hover/link:text-amber-500 group-hover/link:translate-x-0.5 transition-all"></i>Program Kemitraan</a></li>
                    </ul>
                </div>
                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <ul class="space-y-4 text-xs text-stone-400">
                        <li class="flex items-start gap-3.5 group/item">
                            <span class="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 text-amber-500 group-hover/item:bg-amber-500 group-hover/item:text-stone-950 group-hover/item:border-amber-500 transition duration-300"><i data-lucide="map-pin" class="w-4 h-4"></i></span>
                        ...
                        <li class="flex items-center gap-3.5 group/item">
                            <span class="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 text-amber-500 group-hover/item:bg-amber-500 group-hover/item:text-stone-950 group-hover/item:border-amber-500 transition duration-300"><i data-lucide="phone" class="w-4 h-4"></i></span>
                            <span class="group-hover/item:text-stone-200 transition duration-200">{{ $settings['contact_phone'] ?? '+62 21 5200 8888' }}</span>
                        </li>
                        <li class="flex items-center gap-3.5 group/item">
                            <span class="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 text-amber-500 group-hover/item:bg-amber-500 group-hover/item:text-stone-950 group-hover/item:border-amber-500 transition duration-300"><i data-lucide="mail" class="w-4 h-4"></i></span>
                            <span class="group-hover/item:text-stone-200 transition duration-200">{{ $settings['contact_email'] ?? 'info@izitravel.co.id' }}</span>
                        </li>
                        <li class="flex items-center gap-3.5 group/item">
                            <span class="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 text-amber-500 group-hover/item:bg-amber-500 group-hover/item:text-stone-950 group-hover/item:border-amber-500 transition duration-300"><i data-lucide="clock" class="w-4 h-4"></i></span>
                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="rounded-2xl overflow-hidden border border-white/10 shadow-2xl h-28 relative group transition duration-300 hover:border-blue-500/30">
                        ...
                        <div class="absolute inset-0 bg-stone-950/40 group-hover:bg-stone-950/10 transition duration-300 pointer-events-none flex items-end p-2.5">
                            <span class="text-[9px] font-bold text-white/80 bg-stone-900/90 backdrop-blur-sm px-2 py-1 rounded-md border border-white/5 flex items-center gap-1 shadow-sm"><i data-lucide="map" class="w-2.5 h-2.5 text-amber-500"></i>Lokasi Kantor Pusat</span>
                        </div>
                    </div>
                    <div class="relative overflow-hidden bg-gradient-to-br from-amber-500/10 via-amber-600/[0.03] to-transparent border border-amber-500/25 rounded-2xl p-5 shadow-[0_8px_32px_0_rgba(217,119,6,0.05)] backdrop-blur-sm group hover:border-amber-500/40 transition duration-300">
                        ...
                        <div class="flex items-center gap-3.5 mb-3">
                            <div class="w-10 h-10 rounded-xl bg-amber-500/15 border border-amber-500/35 flex items-center justify-center text-amber-400 group-hover:scale-110 transition duration-300"><i data-lucide="award" class="w-5.5 h-5.5"></i></div>
                            <div>
                        ...
                        <p class="text-base font-black tracking-widest text-stone-100 font-heading">No: {{ $settings['footer_ppiu_number'] ?? '91202054619660001' }}</p>
                        <p class="text-[10px] text-stone-400 mt-2 flex items-center gap-1.5 font-medium"><i data-lucide="check-circle" class="w-3.5 h-3.5 text-emerald-400"></i>Terakreditasi A Penyelenggara Umrah</p>
                    </div>
                </div>
            </div>
    ...
    <div class="md:hidden fixed bottom-4 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-md bg-white/95 backdrop-blur-md border border-stone-100 rounded-full shadow-[0_-10px_35px_-10px_rgba(0,0,0,0.1),_0_10px_35px_-10px_rgba(0,0,0,0.05)] px-6 py-3 z-50">
        <div class="flex items-center justify-between text-stone-500 font-medium">
            ...
            <a href="{{ route('public.jemaah.tracking') }}" class="flex flex-col items-center gap-1 text-blue-600 transition active:scale-95">
                <i data-lucide="search-check" class="w-5 h-5"></i>
                <span class="text-[9px] font-extrabold uppercase tracking-wider">Status</span>
            </a>
            <a href="{{ route('public.articles.index') }}" class="flex flex-col items-center gap-1 hover:text-blue-600 transition active:scale-95">
    ...
    <div id="mobile-drawer" class="fixed inset-0 z-[100] invisible flex justify-end transition-all duration-300" role="dialog" aria-modal="true">
        <div id="mobile-drawer-backdrop" class="fixed inset-0 bg-stone-950/40 opacity-0 transition-opacity duration-300 backdrop-blur-sm"></div>
        <div id="mobile-drawer-content" class="relative w-full max-w-xs bg-white h-full shadow-2xl p-6 flex flex-col gap-6 transform translate-x-full transition-transform duration-300 z-10">
            <div class="flex-1 overflow-y-auto scrollbar-none space-y-6 pr-1">
                <div class="flex items-center justify-between pb-4 border-b border-stone-100">
                    ...
                    <button id="mobile-drawer-close" class="w-8 h-8 rounded-full bg-stone-50 border border-stone-100 flex items-center justify-center text-stone-500 hover:text-stone-800 transition active:scale-95 shadow-sm">
                        <i data-lucide="x" class="w-4 h-4"></i>
                    </button>
                </div>
                <div class="flex flex-col space-y-1">
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ url('/') }}#beranda">
                        <span class="w-8 h-8 rounded-xl bg-stone-50 text-stone-500 flex items-center justify-center border border-stone-200/50"><i data-lucide="home" class="w-4 h-4"></i></span>
                        Beranda
                    </a>
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ url('/') }}#tentang-kami">
                    ...
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ url('/') }}#paket-umrah">
                    ...
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ route('public.gallery') }}">
                    ...
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ route('public.testimonials') }}">
                    ...
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ route('public.articles.index') }}">
                    ...
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ url('/') }}#kemitraan">
                    ...
                    <a class="mobile-nav-link flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-stone-700 hover:text-blue-600 hover:bg-blue-50/50 transition duration-200 font-semibold text-xs" href="{{ url('/') }}#kontak">
